//cityName is the parameter for this function
 function calculateTime(cityName) {
   ...
   } else if (cityName === "Darwin, Australia") {
     cityHour = portlandTime + 17;
   } else if (cityName === "Brasilia, Brazil") {
     cityHour = portlandTime + 4;
   } else if (cityName === "Abuja, Nigeria") {
     cityHour = portlandTime + 8;
   } else if (cityName === "Astana, Kazakhstan") {
     cityHour = portlandTime + 13;
   }
